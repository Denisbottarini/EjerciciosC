/*
 ============================================================================
 Name        : proyectoparaentregardelossabados.c
 Author      : 
 Version     :
...
int main(void)
{
	...
	contadorProductosDeChina = 0;
			...
			printf("Mínimo importe: %d , con su pais: %d \n", minimoImporte , paisConPrecioMasBajo);
			//B) Promedio importe
			printf("Promedio importe: %d", promedioImporte);
			//C) Cantidad de productos de China (c)
			printf("Cantidad de productos de China: %d", contadorProductosDeChina);
			//D) Sobre el mínimo encontrado aplicar un descuento del 10% a dicho importe
			descuentoDel10 = minimoImporte * 0.9;
			printf("Cantidad de productos de China: %d", descuentoDel10);
